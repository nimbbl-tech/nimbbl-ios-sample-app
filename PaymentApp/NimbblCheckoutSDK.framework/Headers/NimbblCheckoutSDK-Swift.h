...
#ifndef NIMBBLCHECKOUTSDK_SWIFT_H
#define NIMBBLCHECKOUTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NimbblCheckoutSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP17NimbblCheckoutSDK22NimbblCheckoutDelegate_")
@protocol NimbblCheckoutDelegate
